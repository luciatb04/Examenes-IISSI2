      ...
      {({ handleSubmit }) => (
        <View style={{ alignItems: 'center' }}>
          <View style={styles.container}>
            ...
            >
              <TextRegular textStyle={styles.text}>Sign in</TextRegular>
            </Pressable>

            <TextRegular textStyle={{ textAlign: 'center' }}>
              Not a member?
            </TextRegular>
            <Pressable
            ...
            >
              <TextRegular textStyle={styles.text}>Create account</TextRegular>
            </Pressable>
          </View>
        </View>
      )}
